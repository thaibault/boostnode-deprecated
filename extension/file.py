...
##
        '''
            ...
            >>> handler.set_content('test', encoding='US-ASCII')
            'test'
            >>> handler.encoding
            'US-ASCII'
        '''
...
##                         self.DEFAULT_ENCODING))
                with builtins.open(
                    ...
                    try:
                        self._content = builtins.str(file.read())
...
##
        ...
        if not 'encoding' in keywords:
            ...
            self._encoding = keywords['encoding']
## python2.7
##         with codecs.open(self._path, mode, *arguments, **keywords) as file:
##             self._content = file.write(content.decode(self._encoding))
##         '''
...
##         with codecs.open(
##             self._path, mode='w', encoding=self._encoding, errors='strict'
##         ) as file:
##             file.write(content_utf_8)
        with builtins.open(
            self._path, mode, *arguments, **keywords
        ) as file:
            self._content = file.write(content)
##
        return self.content
...
##
        ...
        for file in self:
            ...
            if builtins.isinstance(function, builtins.str):
                ...
                if result is False:
                    return False
            if recursive and file.is_directory(allow_link=recursive_in_link):
                '''
...
##
    ...
    @boostNode.paradigm.aspectOrientation.JointPoint
## python2.7     def open(self):
    def open(self: boostNode.extension.type.Self) -> builtins.tuple:
        '''
