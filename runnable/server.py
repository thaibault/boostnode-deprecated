    ...
    COMMAND_LINE_ARGUMENTS = (
        ...
        {'arguments': ('-E', '--encoding'),
         'keywords': {
             ...
             'type': {'execute': 'type(__initializer_default_value__)'},
             'required': {'execute': '__initializer_default_value__ is None'},
             'help': 'Sets encoding for interpreting binary data like post '
                     "or authentication requests, decoding given url's or "
                     'encoding compressed gzip data for clients.',
             'dest': 'encoding',
             'metavar': 'STRING'}},
...
##         public_key_file_path='', stop_order='stop', encoding='utf_8',
...
## python2.7     def _create_environment_variables(self):
    def _create_environment_variables(self: Self) -> Self:
...
## python2.7     def _default_get(self):
    ...
    @JointPoint
## python2.7     def _default_get_module(self):
    def _default_get_module(self: Self) -> builtins.bool:
...
##
    ...
    @JointPoint
## python2.7     def _gzip(self, content):
    def _gzip(self: Self, content: builtins.str) -> builtins.str:
