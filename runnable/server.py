...
##
        ...
        '''
## python2.7         if not __test_mode__ and self.headers.getheader('Cookie'):
        if not __test_mode__ and self.headers.get('Cookie'):
            cookie = cookies.SimpleCookie()
## python2.7             cookie.load(self.headers.getheader('Cookie'))
